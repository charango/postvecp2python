...
def plottotaldissipation():
    ...
    legend = plt.legend(loc='upper left',fontsize=13,facecolor='white',edgecolor='white',framealpha=1.0,numpoints=1,bbox_transform=plt.gcf().transFigure)
